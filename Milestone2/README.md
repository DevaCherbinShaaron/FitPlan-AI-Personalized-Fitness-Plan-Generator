...
## **💻 Technologies Used**
* **Inference Client**: For high-speed, serverless LLM calls.
* **PyTorch**: Underlying tensor management for model interactions.
* **Accelerate**: Optimized model loading and memory management.
* **Streamlit**: Updated to handle multi-page session states and markdown rendering.
